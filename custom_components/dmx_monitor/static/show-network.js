...
<div class="footer"><button class="btn primary" id="modules">Modules & configuration</button><button class="btn" id="ha-config">Configuration générale HA</button><button class="btn" id="classic">Vue classique</button><button class="btn" id="timeline">Show Timeline</button><button class="btn" id="archive">Journal & backups</button></div>`;
  ...
  _renderModule(key){
    ...
    if(key==='audio'){
      const rows=[['Dante packets',this._value('dante_packets','—')],['Dante sources',this._value('dante_sources','—')],['Dante sources fraîches',this._value('dante_fresh_sources','—')],['Dante endpoints',this._value('dante_endpoints','—')],['Dante mDNS',this._value('dante_mdns_matches','—')],['Horloge PTP',this._truthy(this._value('ptp_clock_present','false'))?'PRÉSENTE':'NON OBSERVÉE'],['Âge horloge PTP',this._value('ptp_clock_age_s','—')+' s'],['Grandmaster',this._value('ptp_grandmaster_identity','—')],['Domaine PTP',this._value('ptp_last_domain','—')],['PTP packets',this._value('ptp_packets','—')],['PTP sources',this._value('ptp_sources','—')],['AES67 SAP',this._value('aes67_sap_packets','—')],['Sessions AES67/SDP',this._value('aes67_session_count','—')],['ST2110 RTP',this._value('st2110_rtp_packets','—')],['AVB packets',this._value('avb_packets','—')]];
